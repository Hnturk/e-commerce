...
function ProductDetail(props) {
  ...
  return (
    ...
    //         props.id
    //         )}> Add to Cart </button>
    //       <div className="text-product">{props.description}</div>
    //     </div>
    //   </div>
    // </div>
    ...
    //   ></img>
    //   <div className="info-product">
    //     <div className="name-product">Iphone 12</div>
    //     <div className="price-product">$12324</div>
    //     <div className="center">
    //       <Button
    ...
    //   </div>
    // </div>,
    <div className="card mb-5" style={{ maxWidth: '1040px' }}>
